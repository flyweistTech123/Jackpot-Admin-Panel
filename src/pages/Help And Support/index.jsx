...
const HelpAndSupport = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        await getApi(endPoints.getHelpAndSupport, {
            setResponse: setHelpAndSupportData,
    ...
    useEffect(() => {
        setContent(helpandsupportData?.data?.description);
    }, [helpandsupportData]);
    ...
    const handleSubmit = async () => {
        ...
        await postApi(endPoints.addHelpAndSupport, payload, {
            setLoading: setLoading1,
            successMsg: "Help And Support description Updated successfully!",
            errorMsg: "Failed to Update Help And Support description!",
            additionalFunctions: [
                () => fetchData(),
            ],
        });
    ...
    return (
        <DashbaordLayout title="Help And Support"
            hedartitle="Help And Support"
        >
            {loading ?
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 border p-4 rounded shadow bg-white">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold">Help And Support Editor</h2>
                                <button
