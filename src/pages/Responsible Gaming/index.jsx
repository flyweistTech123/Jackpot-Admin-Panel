...
const ResponsibleGaming = () => {
    ...
    const [responsiblegamingData, setResponsibleGamingData] = useState({});
    ...
    const fetchData = useCallback(async () => {
        setResponsibleGamingData({})
        await getApi(endPoints.getResponsibleGaming, {
            setResponse: setResponsibleGamingData,
    ...
    useEffect(() => {
        setContent(responsiblegamingData?.data?.description);
    ...
    const handleSubmit = async () => {
        ...
        await postApi(endPoints.addResponsibleGaming, payload, {
            setLoading: setLoading1,
            successMsg: "Responsible Gaming description Updated successfully!",
            errorMsg: "Failed to Update Responsible Gaming description!",
            additionalFunctions: [
                () => fetchData(),
            ],
        });
    ...
    return (
        <DashbaordLayout title="Responsible Gaming"
            hedartitle="Responsible Gaming"
        >
            {loading ?
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 border p-4 rounded shadow bg-white">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold">Responsible Gaming Editor</h2>
                                <button
