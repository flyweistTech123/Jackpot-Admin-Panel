...
const PoweredByCompany = () => {
    const navigate = useNavigate();
    const [poweredbycompanyData, setPoweredByCompanyData] = useState({});
    ...
    const fetchData = useCallback(async () => {
        setPoweredByCompanyData({})
        await getApi(endPoints.getpoweredbycompany, {
            setResponse: setPoweredByCompanyData,
    ...
    useEffect(() => {
        setContent(poweredbycompanyData?.data?.description);
    }, [poweredbycompanyData]);
    ...
    const handleSubmit = async () => {
        ...
        const payload = {
            title: "Powered by Company Technologies",
            description: content
        }

        await postApi(endPoints.addpoweredbycompany, payload, {
            setLoading: setLoading1,
            successMsg: "Powered By Company description Updated successfully!",
            errorMsg: "Failed to Update Powered By Company description!",
            additionalFunctions: [
                () => fetchData(),
            ],
        });
    ...
    return (
        <DashbaordLayout title="Powered By Company"
            hedartitle="Powered By Company"
        >
            {loading ?
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 border p-4 rounded shadow bg-white">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold">Powered By Company Editor</h2>
                                <button
...
export default PoweredByCompany