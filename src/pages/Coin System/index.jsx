...
const CoinSystem = () => {
    ...
    const [coinsystemData, setCoinSystemData] = useState({});
    ...
    const fetchData = useCallback(async () => {
        setCoinSystemData({})
        await getApi(endPoints.getCoinSystem, {
            setResponse: setCoinSystemData,
    ...
    useEffect(() => {
        setContent(coinsystemData?.data?.description);
    }, [coinsystemData]);
    ...
    const handleSubmit = async () => {
        ...
        await postApi(endPoints.addCoinSystem, payload, {
            setLoading: setLoading1,
            successMsg: "Coin System Updated successfully!",
            errorMsg: "Failed to Update Coin System!",
            additionalFunctions: [
                () => fetchData(),
            ],
        });
    ...
    return (
        <DashbaordLayout title="Coin System"
            hedartitle="Coin System"
        >
            {loading ?
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 border p-4 rounded shadow bg-white">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold">Coin System Editor</h2>
                                <button
