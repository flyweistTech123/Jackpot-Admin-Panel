...
const HowToPlay = () => {
    ...
    const fetchData = useCallback(async () => {
        setHowToPlayData({})
        await getApi(endPoints.getHowToPlay, {
            setResponse: setHowToPlayData,
    ...
    useEffect(() => {
        setContent(howtoplayData?.data?.description);
    }, [howtoplayData]);
    ...
    const handleSubmit = async () => {
        ...
        await postApi(endPoints.addHowToPlay, payload, {
            setLoading: setLoading1,
            successMsg: "How To Play description Updated successfully!",
            errorMsg: "Failed to Update How To Play description!",
            additionalFunctions: [
                () => fetchData(),
            ],
        });
    ...
    return (
        <DashbaordLayout title="How To Play"
            hedartitle="How To Play"
        >
            {loading ?
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 border p-4 rounded shadow bg-white">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold">How To Play Editor</h2>
                                <button
