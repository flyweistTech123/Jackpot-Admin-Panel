...
import { AddNewLocationModal, ConfirmModal } from '../../../components/Modals/Modal';
...
const Locations = () => {
    ...
    const handleConfirm = async () => {
        ...
        await deleteApi(endPoints.deleteLocation(itemToDelete), {
            setLoading: setDeleteLoading,
            successMsg: "Location deleted successfully!",
            errorMsg: "Failed to delete location!",
            additionalFunctions: [
                () => setShowModal(false),
                () => fetchData(),
            ],
    ...
    return (
        <DashbaordLayout
            title="Locations"
            hedartitle={`Website > Jobs > Locations`}
            titleAction={
                        ...
                        <tbody className="font-manrope text-[15px] font-[400] text-[#000000]">
                            {loading ?
                                ...
                                (!locationsData?.data || locationsData?.data?.length === 0) ? (
                                    ...
                                    locationsData?.data?.map((i, index) => (
