...
import { AddNewDepartmentModal, ConfirmModal } from '../../../components/Modals/Modal';
...
const Departments = () => {
    ...
    const handleConfirm = async () => {
        ...
        await deleteApi(endPoints.deleteDepartment(itemToDelete), {
    ...
    return (
        <DashbaordLayout
            title="Departments"
            hedartitle={`Website > Jobs > Departments`}
            titleAction={
                        ...
                        <tbody className="font-manrope text-[15px] font-[400] text-[#000000]">
                            {loading ?
                                ...
                                (!departmentData?.data || departmentData?.data?.length === 0) ? (
                                    ...
                                    departmentData?.data?.map((i, index) => (
