...
const TermsandConditions = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        await getApi(endPoints.getTermsandConditions, {
            setResponse: setTermsandConditionsData,
    ...
    useEffect(() => {
        setContent(termsandconditionsData?.data?.description);
    ...
    const handleSubmit = async () => {
        ...
        await postApi(endPoints.addTermsandConditions, payload, {
            setLoading: setLoading1,
            successMsg: "Terms and Conditions Updated successfully!",
            errorMsg: "Failed to Update Terms and Conditions!",
            additionalFunctions: [
                () => fetchData(),
            ],
        });
    ...
    return (
        <DashbaordLayout title="Terms and Conditions"
            hedartitle="Terms and Conditions"
        >
            {loading ?
